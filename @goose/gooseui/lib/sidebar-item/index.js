...
var _default = createComponent({
  mixins: [(0, _relation.ChildrenMixin)('gooseSidebar')],
  ...
  render: function render() {
    ...
    if (process.env.NODE_ENV === 'development' && this.info) {
      console.warn('[GooseUI] SidebarItem: "info" prop is deprecated, use "badge" prop instead.');
    }
    ...
    return h("a", {
      ...
      "class": bem('text')
    }, [(_this$slots = this.slots('title')) !== null && _this$slots !== void 0 ? _this$slots : this.title, h(_info.default, {
      "attrs": {
        "dot": this.dot,
