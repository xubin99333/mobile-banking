(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("gooseui", ["vue"], factory);
	else if(typeof exports === 'object')
		exports["gooseui"] = factory(require("vue"));
	else
		root["gooseui"] = factory(root["Vue"]);
...
var isServer = external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_default.a.prototype.$isServer; // eslint-disable-next-line @typescript-eslint/no-empty-function
    ...
    methods: {
      ...
      addLock: function addLock() {
        if (this.lockScroll) {
          ...
          if (!context_context.lockCount) {
            document.body.classList.add('goose-overflow-hidden');
          }
      ...
      removeLock: function removeLock() {
        if (this.lockScroll && context_context.lockCount) {
          ...
          if (!context_context.lockCount) {
            document.body.classList.remove('goose-overflow-hidden');
          }
        }
      },
...
function Icon(h, props, slots, ctx) {
  ...
  return h(props.tag, helper_default()([{
    ...
    "attrs": {
      "dot": props.dot,
      "info": (_props$badge = props.badge) !== null && _props$badge !== void 0 ? _props$badge : props.info
    }
  })]);
}
...
/* harmony default export */ var popup = (popup_createComponent({
  ...
  render: function render() {
    ...
    var transitionName = this.transition || (isCenter ? 'goose-fade' : "goose-popup-slide-" + position);
    var style = {};
...
function LoadingText(h, props, slots) {
  if (slots.default) {
    ...
    var style = {
      ...
      color: (_props$textColor = props.textColor) !== null && _props$textColor !== void 0 ? _props$textColor : props.color
    };
    return h("span", {
  ...
  methods: {
    ...
    formatCascade: function formatCascade() {
      ...
      while (cursor && cursor.children) {
        ...
        var defaultIndex = (_cursor$defaultIndex = cursor.defaultIndex) !== null && _cursor$defaultIndex !== void 0 ? _cursor$defaultIndex : +this.defaultIndex;
    ...
    genTitle: function genTitle() {
      ...
      if (this.title) {
        return h("div", {
          "class": ['goose-ellipsis', picker_bem('title')]
        }, [this.title]);
      }
    },
      ...
      return this.formattedColumns.map(function (item, columnIndex) {
        ...
        return h(PickerColumn, {
          "attrs": {
            ...
            "defaultIndex": (_item$defaultIndex = item.defaultIndex) !== null && _item$defaultIndex !== void 0 ? _item$defaultIndex : +_this5.defaultIndex,
...
function Cell(h, props, slots, ctx) {
  ...
  var clickable = (_props$clickable = props.clickable) !== null && _props$clickable !== void 0 ? _props$clickable : isLink;
  var classes = {
    clickable: clickable,
    center: props.center,
...
/* harmony default export */ var es_field = (field_createComponent({
  ...
  mounted: function mounted() {
    ...
    if (this.gooseForm) {
      this.gooseForm.addField(this);
    }
  },
  beforeDestroy: function beforeDestroy() {
    if (this.gooseForm) {
      this.gooseForm.removeField(this);
    }
  },
  computed: {
    ...
    showError: function showError() {
      ...
      if (this.gooseForm && this.gooseForm.showError && this.validateFailed) {
        return true;
      }
    },
  ...
  methods: {
    ...
    validateWithTrigger: function validateWithTrigger(trigger) {
      if (this.gooseForm && this.rules) {
        var defaultTrigger = this.gooseForm.validateTrigger === trigger;
    ...
    genMessage: function genMessage() {
      ...
      if (this.gooseForm && this.gooseForm.showErrorMessage === false) {
        return;
      }
    ...
    getProp: function getProp(key) {
      ...
      if (this.gooseForm && isDef(this.gooseForm[key])) {
        return this.gooseForm[key];
      }
    },
...
/* harmony default export */ var goods_action = (goods_action_createComponent({
  mixins: [ParentMixin('gooseGoodsAction')],
  props: {
    safeAreaInsetBottom: {
      type: Boolean,
      default: true
...
/* harmony default export */ var goods_action_button = (goods_action_button_createComponent({
  mixins: [ChildrenMixin('gooseGoodsAction')],
...
/* harmony default export */ var radio_group = (radio_group_createComponent({
  mixins: [ParentMixin('gooseRadio'), FieldMixin],
  props: {
    value: null,
    disabled: Boolean,
    direction: String,
...
function Tag(h, props, slots, ctx) {
  ...
  return h("transition", {
    "attrs": {
      "name": props.closeable ? 'goose-fade' : null
    }
...
// CONCATENATED MODULE: ./es/utils/dom/raf.js
/**
...
function Card(h, props, slots, ctx) {
  ...
  function Title() {
    ...
    if (props.title) {
      return h("div", {
        "class": [card_bem('title'), 'goose-multi-ellipsis--l2']
      }, [props.title]);
    }
  }
  ...
  function Desc() {
    ...
    if (props.desc) {
      return h("div", {
        "class": [card_bem('desc'), 'goose-ellipsis']
      }, [props.desc]);
    }
  }
...
/* harmony default export */ var tab = (tab_createComponent({
  mixins: [ChildrenMixin('gooseTabs')],
  props: _extends({}, routeProps, {
    dot: Boolean,
    name: [Number, String],
    // @deprecated
...
/* harmony default export */ var tabs = (tabs_createComponent({
  mixins: [ParentMixin('gooseTabs'), BindEventMixin(function (bind) {
    if (!this.scroller) {
      this.scroller = getScroller(this.$el);
    }
...
/* harmony default export */ var checkbox_group = (checkbox_group_createComponent({
  mixins: [ParentMixin('gooseCheckbox'), FieldMixin],
  props: {
    max: [Number, String],
    disabled: Boolean,
    direction: String,
  ...
  methods: {
    ...
    toggleAll: function toggleAll(options) {
      ...
      var children = this.children.filter(function (item) {
        ...
        return checked !== null && checked !== void 0 ? checked : !item.checked;
      });
...
/* harmony default export */ var circle = (circle_createComponent({
  ...
  beforeCreate: function beforeCreate() {
    this.uid = "goose-circle-gradient-" + circle_uid++;
  },
  computed: {
    style: function style() {
...
/* harmony default export */ var collapse = (collapse_createComponent({
  mixins: [ParentMixin('gooseCollapse')],
  props: {
    accordion: Boolean,
...
/* harmony default export */ var collapse_item = (collapse_item_createComponent({
  mixins: [ChildrenMixin('gooseCollapse')],
  props: _extends({}, cellProps, {
    name: [Number, String],
    disabled: Boolean,
    isLink: {
...
/* harmony default export */ var dropdown_item = (dropdown_item_createComponent({
  mixins: [PortalMixin({
    ref: 'wrapper'
  }), ChildrenMixin('gooseDropdownMenu')],
  props: {
    value: null,
    title: String,
    disabled: Boolean,
...
/* harmony default export */ var dropdown_menu = (dropdown_menu_createComponent({
  mixins: [ParentMixin('gooseDropdownMenu'), click_outside_ClickOutsideMixin({
    event: 'click',
...
var Network_prefix = 'goose-empty-network-';
/* harmony default export */ var Network = ({
  render: function render() {
    ...
    return h("svg", {
      ...
      "attrs": {
        "fill": "url(#" + Network_prefix + "7)",
        "d": "M0 139h160v21H0z"
      }
    }), h("path", {
      "attrs": {
        "d": "M37 18a7 7 0 013 13.326v26.742c0 1.23-.997 2.227-2.227 2.227h-1.546A2.227 2.227 0 0134 58.068V31.326A7 7 0 0137 18z",
        "fill": "url(#" + Network_prefix + "2)",
        "fill-rule": "nonzero",
  ...
  methods: {
    genImageContent: function genImageContent() {
      ...
      if (PRESETS.indexOf(image) !== -1) {
        image = "https://goosedoc.mengqingyun.cn:8443/images/empty-image-" + image + ".png";
      }
...
var goods_action_icon_createNamespace = createNamespace('goods-action-icon'),
...
/* harmony default export */ var goods_action_icon = (goods_action_icon_createComponent({
  ...
  methods: {
    ...
    genIcon: function genIcon() {
      ...
      var info = (_this$badge = this.badge) !== null && _this$badge !== void 0 ? _this$badge : this.info;
...
/* harmony default export */ var grid_item = (grid_item_createComponent({
  mixins: [ChildrenMixin('gooseGrid')],
  props: _extends({}, routeProps, {
    dot: Boolean,
    text: String,
    icon: String,
...
/* harmony default export */ var swipe = (swipe_createComponent({
  mixins: [TouchMixin, ParentMixin('gooseSwipe'), BindEventMixin(function (bind, isBind) {
    bind(window, 'resize', this.resize, true);
...
/* harmony default export */ var swipe_item = (swipe_item_createComponent({
  mixins: [ChildrenMixin('gooseSwipe')],
  data: function data() {
    return {
      offset: 0,
      inited: false,
...
/* harmony default export */ var index_anchor = (index_anchor_createComponent({
  mixins: [ChildrenMixin('gooseIndexBar', {
...
/* harmony default export */ var index_bar = (index_bar_createComponent({
  mixins: [TouchMixin, ParentMixin('gooseIndexBar'), BindEventMixin(function (bind) {
    if (!this.scroller) {
      this.scroller = getScroller(this.$el);
    }
  ...
  methods: {
    ...
    genNavBar: function genNavBar() {
      ...
      return h("div", {
        ...
        "class": [nav_bar_bem('title'), 'goose-ellipsis']
...
/* harmony default export */ var number_keyboard = (number_keyboard_createComponent({
  ...
  render: function render() {
    ...
    return h("transition", {
      "attrs": {
        "name": this.transition ? 'goose-slide-up' : ''
      }
    }, [h("div", {
      "directives": [{
        name: "show",
...
/* harmony default export */ var pagination = (pagination_createComponent({
  ...
  render: function render() {
    ...
    return h("ul", {
    ...
    }, [((_this$slots = this.slots('prev-text')) !== null && _this$slots !== void 0 ? _this$slots : this.prevText) || pagination_t('prev')]), this.pages.map(function (page) {
      var _this$slots2;
      ...
      }, [(_this$slots2 = _this.slots('page', page)) !== null && _this$slots2 !== void 0 ? _this$slots2 : page.text]);
    }), simple && h("li", {
    ...
    }, [((_this$slots3 = this.slots('next-text')) !== null && _this$slots3 !== void 0 ? _this$slots3 : this.nextText) || pagination_t('next')])]);
  }
}));
...
var panel_createNamespace = createNamespace('panel'),
...
var getBoundingClientRect_round = Math.round;
function getBoundingClientRect(element, includeScale) {
  ...
  return {
    width: getBoundingClientRect_round(rect.width / scaleX),
    height: getBoundingClientRect_round(rect.height / scaleY),
    top: getBoundingClientRect_round(rect.top / scaleY),
    right: getBoundingClientRect_round(rect.right / scaleX),
    bottom: getBoundingClientRect_round(rect.bottom / scaleY),
    left: getBoundingClientRect_round(rect.left / scaleX),
    x: getBoundingClientRect_round(rect.left / scaleX),
    y: getBoundingClientRect_round(rect.top / scaleY)
  };
}
...
var enums_left = 'left';
var auto = 'auto';
var basePlacements = [enums_top, enums_bottom, right, enums_left];
...
// CONCATENATED MODULE: ./es/popover/index.js
 // import { createPopper, offsetModifier } from '@goose/popperjs';
...
/* harmony default export */ var popover = (popover_createComponent({
  ...
  methods: {
    createPopper: function createPopper() {
      return popper_lite_createPopper(this.$refs.wrapper, this.$refs.popover.$el, {
...
/* harmony default export */ var es_progress = (progress_createComponent({
  ...
  render: function render() {
    ...
    var text = pivotText !== null && pivotText !== void 0 ? pivotText : percentage + '%';
...
/* harmony default export */ var share_sheet = (share_sheet_createComponent({
  ...
  methods: {
    ...
    genCancelText: function genCancelText() {
      ...
      var h = this.$createElement;
      var cancelText = (_this$cancelText = this.cancelText) !== null && _this$cancelText !== void 0 ? _this$cancelText : share_sheet_t('cancel');
...
/* harmony default export */ var sidebar = (sidebar_createComponent({
  mixins: [ParentMixin('gooseSidebar')],
  model: {
    prop: 'activeKey'
  },
  props: {
...
/* harmony default export */ var sidebar_item = (sidebar_item_createComponent({
  mixins: [ChildrenMixin('gooseSidebar')],
  props: _extends({}, routeProps, {
    dot: Boolean,
    // @deprecated
    info: [Number, String],
  ...
  render: function render() {
    ...
    }, [(_this$slots = this.slots('title')) !== null && _this$slots !== void 0 ? _this$slots : this.title, h(es_info, {
      "attrs": {
        "dot": this.dot,
...
var SkuHeader_createNamespace = createNamespace('sku-header'),
...
var SkuHeaderItem_createNamespace = createNamespace('sku-header-item'),
...
var SkuRow_createNamespace = createNamespace('sku-row'),
...
/* harmony default export */ var SkuRow = (SkuRow_createComponent({
  mixins: [ParentMixin('gooseSkuRows'), BindEventMixin(function (bind) {
...
/* harmony default export */ var SkuRowItem = (SkuRowItem_createComponent({
  ...
  render: function render() {
    ...
    return h("span", {
      ...
      "class": {
        'goose-multi-ellipsis--l2': this.largeImageMode
      }
...
var SkuRowPropItem_createNamespace = createNamespace('sku-row-prop-item'),
...
/* harmony default export */ var SkuRowPropItem = (SkuRowPropItem_createComponent({
  ...
  render: function render() {
    var h = arguments[0];
    return h("span", {
      "class": ['goose-sku-row__item', {
        'goose-sku-row__item--active': this.choosed
      }],
      "on": {
        "click": this.onSelect
      }
    }, [h("span", {
      "class": "goose-sku-row__item-name"
    }, [this.skuValue.name])]);
  }
}));
...
/* harmony default export */ var stepper = (stepper_createComponent({
  ...
  data: function data() {
    ...
    var defaultValue = (_this$value = this.value) !== null && _this$value !== void 0 ? _this$value : this.defaultValue;
  ...
  methods: {
    ...
    format: function format(value) {
      ...
      value = value === '' ? 0 : +value;
      value = number_isNaN(value) ? this.min : value;
...
/* harmony default export */ var SkuStepper = (SkuStepper_createComponent({
  ...
  render: function render() {
    ...
    var h = arguments[0];
    return h("div", {
      "class": "goose-sku-stepper-stock"
    }, [h("div", {
      "class": "goose-sku__stepper-title"
      ...
      "class": "goose-sku__stepper-quota"
    }, ["(", this.quotaText, ")"])]);
  }
}));
...
var uploader_createNamespace = createNamespace('uploader'),
...
/* harmony default export */ var uploader = (uploader_createComponent({
  ...
  methods: {
    ...
    onDelete: function onDelete(file, index) {
      ...
      var beforeDelete = (_file$beforeDelete = file.beforeDelete) !== null && _file$beforeDelete !== void 0 ? _file$beforeDelete : this.beforeDelete;
    ...
    genPreviewItem: function genPreviewItem(item, index) {
      ...
      var h = this.$createElement;
      var deleteAble = (_item$deletable = item.deletable) !== null && _item$deletable !== void 0 ? _item$deletable : this.deletable;
      ...
      var previewSize = (_item$previewSize = item.previewSize) !== null && _item$previewSize !== void 0 ? _item$previewSize : this.previewSize;
      var imageFit = (_item$imageFit = item.imageFit) !== null && _item$imageFit !== void 0 ? _item$imageFit : this.imageFit;
      var Preview = isImageFile(item) ? h(es_image, {
        ...
        "class": [uploader_bem('file-name'), 'goose-ellipsis']
...
var SkuImgUploader_namespace = createNamespace('sku-img-uploader');
...
var SkuDateTimeField_namespace = createNamespace('sku-datetime-field');
...
var SkuMessages_createNamespace = createNamespace('sku-messages'),
...
var SkuActions_createNamespace = createNamespace('sku-actions'),
...
var Sku_namespace = createNamespace('sku');
...
/* harmony default export */ var Sku = (Sku_createComponent({
  ...
  computed: {
    skuGroupClass: function skuGroupClass() {
      return ['goose-sku-group-container', {
        'goose-sku-group-container--hide-soldout': !this.showSoldoutSku
      }];
    },
  ...
  methods: {
    resetStepper: function resetStepper() {
      ...
      var num = selectedNum !== null && selectedNum !== void 0 ? selectedNum : this.startSaleNum; // 用来缓存不合法的情况
  ...
  render: function render() {
    ...
    var Header = slots('sku-header') || h(components_SkuHeader, {
      ...
      "class": "goose-sku__goods-price"
    }, [h("span", {
      "class": "goose-sku__price-symbol"
    }, ["\uFFE5"]), h("span", {
      "class": "goose-sku__price-num"
    }, [price]), this.priceTag && h("span", {
      "class": "goose-sku__price-tag"
...
/* harmony default export */ var es_step = (step_createComponent({
  mixins: [ChildrenMixin('gooseSteps')],
  computed: {
...
var switch_cell_createNamespace = createNamespace('switch-cell'),
...
/* harmony default export */ var tabbar = (tabbar_createComponent({
  mixins: [ParentMixin('gooseTabbar')],
  props: {
    route: Boolean,
    zIndex: [Number, String],
    placeholder: Boolean,
...
/* harmony default export */ var tabbar_item = (tabbar_item_createComponent({
  mixins: [ChildrenMixin('gooseTabbar')],
  props: _extends({}, routeProps, {
    dot: Boolean,
    icon: String,
    name: [Number, String],
...
function TreeSelect(h, props, slots, ctx) {
  ...
  function Content() {
    ...
    return subItems.map(function (item) {
      return h("div", {
        "key": item.id,
        "class": ['goose-ellipsis', tree_select_bem('item', {
...
function es_install(Vue) {
  var components = [action_sheet, address_edit, address_list, es_area, badge, es_button, calendar, card, cascader, cell, cell_group, es_checkbox, checkbox_group, circle, col, collapse, collapse_item, contact_card, contact_edit, contact_list, count_down, es_coupon, coupon_cell, coupon_list, datetime_picker, dialog, divider, dropdown_item, dropdown_menu, empty, es_field, es_form, goods_action, goods_action_button, goods_action_icon, grid, grid_item, es_icon, es_image, image_preview, index_anchor, index_bar, es_info, es_list, es_loading, locale, nav_bar, notice_bar, notify, number_keyboard, es_overlay, pagination, panel, password_input, picker, popover, popup, es_progress, pull_refresh, es_radio, radio_group, es_rate, row, search, share_sheet, sidebar, sidebar_item, skeleton, es_sku, slider, es_step, stepper, steps, es_sticky, submit_bar, swipe, swipe_cell, swipe_item, es_switch, switch_cell, tab, tabbar, tabbar_item, tabs, es_tag, es_toast, tree_select, uploader];
