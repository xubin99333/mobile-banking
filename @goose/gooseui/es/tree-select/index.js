...
function TreeSelect(h, props, slots, ctx) {
  ...
  if (process.env.NODE_ENV === 'development') {
    if (ctx.listeners.navclick) {
      console.warn('[GooseUI] TreeSelect: "navclick" event is deprecated, use "click-nav" instead.');
    }

    if (ctx.listeners.itemclick) {
      console.warn('[GooseUI] TreeSelect: "itemclick" event is deprecated, use "click-item" instead.');
    }
  }
